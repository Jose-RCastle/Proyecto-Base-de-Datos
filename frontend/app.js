...
async function entrada(){
    ...
    formSubmit('#entry','/entrada','POST',data=>{notice(`Entrada registrada: estadía #${data.estadia_id}, ${data.placa}, espacio ${data.espacio}.`);content.insertAdjacentHTML('beforeend',ticket(data))});
}
async function salida(){
    ...
    formSubmit('#exit','/salida','POST',data=>{notice(`Estadía #${data.estadia_id} finalizada. Total: ${money(data.total)}.`);content.insertAdjacentHTML('beforeend',ticket(data,true))});
}
